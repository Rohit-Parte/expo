...
async function registerForPushNotificationsAsync() {
  ...
  /* @info On Android, specify channel if you're going to use channelId, if added this code then its mandatory to add channelId in request else notification will not pop-up */
